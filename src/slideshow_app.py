#!/usr/bin/env python3
"""
Slideshow Creator GUI Application (PyQt version)

A PyQt implementation of the GUI for the create_slideshow_v2.py script.
"""
...
from create_slideshow_v2 import create_slideshow
